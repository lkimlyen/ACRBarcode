...
public class ScanWarehousingModel extends RealmObject{
    ...
    public ScanWarehousingModel(int id, String barcode, String deviceTime, String serverTime, double latitude, double longitude, String createByPhone, int packageId, int orderId, int serial, int numCodeScan, int createBy) {
        this.id = id;
