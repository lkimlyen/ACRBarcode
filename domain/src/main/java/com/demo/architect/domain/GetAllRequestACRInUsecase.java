...
public class GetAllRequestACRInUsecase extends BaseUseCase {
    private static final String TAG = GetAllRequestACRInUsecase.class.getSimpleName();
    private final OrderRepository remoteRepository;

    public GetAllRequestACRInUsecase(OrderRepository remoteRepository) {
        this.remoteRepository = remoteRepository;
    }

    @Override
    protected Observable buildUseCaseObservable() {
        return remoteRepository.getAllRequestINACR();
    }
